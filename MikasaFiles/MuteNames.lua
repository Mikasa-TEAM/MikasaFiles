...
if DevAbs:get(Mikasa.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Mikasa.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Mikasa.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Mikasa.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Mikasa.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Mikasa.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
MikasaName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if MikasaName then 
MikasaNames = DevAbs:smembers(Mikasa.."Abs:Mute:Names"..msg.chat_id_) or ""
if MikasaNames and MikasaNames[1] then 
for i=1,#MikasaNames do 
if MikasaName:match("(.*)("..MikasaNames[i]..")(.*)") then 
...
DevAbs:set(Mikasa.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Mikasa.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
